...
# Define the path to config.json relative to the current directory
...
# Load evo_model
# evo = json_data['evo_model']
# rel_to_config_evo_model = os.path.join(script_dir, )
# evo_model = RNNModel.load(rel_to_config_evo_model)
